...
const assets = [
    ...
    '/images/icons/blue-bus.png',
    '/images/icons/orange-bus.png',
    ...
    e.respondWith(
        caches.match(e.request).then(cacheRes => {
            return cacheRes || fetch(e.request).then(async fetchRes => {
                ...
                if (e.request.url.indexOf("dsat.gov.mo") == -1 && e.request.url.indexOf("mapbox") == -1 && e.request.url.indexOf("bus.matthewngan.ga"))
